(function () {
   ...
   */
   ...
   var facebookButton       = resultsPanel.getElementsByTagName('button')['1'];
   var twitterButton        = resultsPanel.getElementsByTagName('button')['2'];
   ...
   */
   ...
   facebookButton.onclick = function() {
      window.open('https://www.facebook.com/sharer/sharer.php?u=' + window.location.href.replace(/#/g, '%23'), '_blank');
   };

   twitterButton.onclick = function() {
      window.open('https://twitter.com/intent/tweet?text=' + window.location.href.replace(/#/g, '%23'), '_blank');
   };
